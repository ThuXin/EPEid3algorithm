...
function(){U._fTWm&&U._fTWm(h)})}function Za(h,p,D){D=D||"normal";var r=h+"_"+p+"_"+D,u=$a[r];if(isNaN(u)){try{h="position:absolute; left:0px; top:-20000px; padding:0px;margin:0px;border:none;white-space:pre;line-height:normal;font-family:"+h+"; font-size:"+p+"px; font-weight:"+D+";";if(!xa){var H=document.body;var F=document.createTextNode("Mpgyi");xa.appendChild(F);H.appendChild(xa)}xa.style.display="";xa.setAttribute("style",h);u=Math.round(xa.offsetHeight);
