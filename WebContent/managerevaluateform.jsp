  ...
  ============================-->
	...
	<%
		...
		String cname = null, attendence = "", assignment = "", english_skill = "", job_skill = "",
				job_position = "", teamwork = "", communication = "";
		double salary = 0.0;
	...
	<div class="container1" style="margin-top: 90px;">
		<div class="shadow-lg p-5 mb-5 bg rounded z-depth-5"
			...
			<s:form class="form-horizontal" action="managerevaluate" method="GET">
				<div class="flex">
					<label for="name">Name</label> <label><%=cname%></label>

				</div>
				<br>

				<div class="flex">
					<label for="salary">Salary</label> <label><%=salary%></label>
				</div>
				<br>
				<div class="flex">
					<label for="id_a">Attendence</label> <label><%=attendence%></label>
				</div>
				<br>

				<div class="flex">
					<label for="id_a">Assignment</label> <label><%=assignment%></label>
				</div>
				<br>

				<div class="flex">
					<label for="id_es">English Skill</label> <label><%=english_skill%></label>
				</div>
				<br>

				<div class="flex">
					<label for="id_a">Job Skill</label> <label><%=job_skill%></label>
				</div>
				<br>

				<div class="flex">
					<label for="id_jp">Job Position</label> <label><%=job_position%></label>
				</div>
				<br>
				<div class="flex">
					<label for="id_a">Teamwork</label> <label><%=teamwork%></label>
				</div>
				<br>
				<div class="flex">
					<label for="id_a">Communication</label> <label><%=communication%></label>
				</div>
				<br>
				...
				<div class="flex">
					...
					<button type="submit" class="btn btn-lg "
						style="color: white; font-family: Trebuchet MS; border-radius: 10px; font-size: 16px; background-color: #4AA5D5"
						onclick=" return confirm('Are you sure you want to evaluate!!!!')">
						Evaluation</button>
