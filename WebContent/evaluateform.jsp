...
<title>Evaluate From Team Leader</title>
  ...
  ============================-->
	...
	<div class="container1" style="margin-top: 90px;">
		<div class="shadow-lg p-5 mb-5 bg rounded z-depth-5"
			...
			<s:form class="form-horizontal" action="evaluate" method="GET">
				<div class="flex">
				...
				<div class="flex">
					<label for="id_ass">Assignment</label> <select name="assignment"
						id="id_ass">
				...
				<div class="flex">
					<label for="id_js">Job Skill</label> <select name="job_skill"
						id="id_js">
				...
				<div class="flex">
					<label for="id_tw">Teamwork</label> <select name="teamwork"
						id="id_tw">
				...
				<div class="flex">
					<label for="id_cs">Communication Skill</label> <select
						name="communication" id="id_cs">
						<option value="excellent">Excellent</option>
						<option value="good">Good</option>
						<option value="normal">Normal</option>
					</select>
